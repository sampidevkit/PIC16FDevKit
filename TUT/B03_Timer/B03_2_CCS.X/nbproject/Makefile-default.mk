...
FINAL_IMAGE=${DISTDIR}/B03_2_CCS.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ShExtension=.bat
Device=PIC16F18877
ProjectDir="F:\Git\SAMPI\P16DK\P16F1887x\TUT\B03_Timer\B03_2_CCS.X"
ProjectName=B03_2_CCS
ConfName=default
ImagePath="${DISTDIR}\B03_2_CCS.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}"
ImageDir="${DISTDIR}"
ImageName="B03_2_CCS.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}"
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
IsDebug="true"
else
IsDebug="false"
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/B03_2_CCS.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
	@echo "--------------------------------------"
...
ifeq (1,1) 
	...
	@mv ${OBJECTDIR}/main.cof "${DISTDIR}/B03_2_CCS.X.${IMAGE_TYPE}.cof" 
	@mv ${OBJECTDIR}/main.hex "${DISTDIR}/B03_2_CCS.X.${IMAGE_TYPE}.hex"
else 
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/B03_2_CCS.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	${MKDIR} ${DISTDIR} 
ifeq (1,1) 
	
else 
	${MP_LD}   out="${DISTDIR}"  +FM +EX +DF +CC LINK=B03_2_CCS.X.${IMAGE_TYPE}.hex=${OBJECTDIR}/main.o +Y=9 +EA ${sourceline.device} +DF +LN +T +A +M +J +Z -P
...
ifeq (1,1) 
	...
	@"C:/Program Files/Microchip/MPLABX/v6.00/mplab_platform/platform/../mplab_ide/modules/../../bin/hexmate" --edf="C:/Program Files/Microchip/MPLABX/v6.00/mplab_platform/platform/../mplab_ide/modules/../../dat/en_msgs.txt" ${DISTDIR}/B03_2_CCS.X.${IMAGE_TYPE}.hex -o${DISTDIR}/B03_2_CCS.X.${IMAGE_TYPE}.hex
