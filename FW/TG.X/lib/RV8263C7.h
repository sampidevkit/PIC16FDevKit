...
/* *************************************************************** BASIC APIs */
// RV8263C7_Init(H24_12)
#define RV8263C7_H24            0
#define RV8263C7_H12            1
void RV8263C7_Init(void);
// RV8263C7_GetState()
#define RV8263C7_OK             0
#define RV8263C7_BUSY           1
#define RV8263C7_ERR            (-1)
int8_t RV8263C7_GetState(void);
...
void RV8263C7_CancelAnyTask(void);
/* ***************************************************************** ADV APIs */
