#ifndef USER_USB_CONFIG_H
#define USER_USB_CONFIG_H
...
#define MAX_LUN                 0   //Includes 0 (ex: 0 = 1 LUN, 1 = 2 LUN, etc.)
#define MSD_DATA_EP             1
#define MSD_DATA_IN_EP          MSD_DATA_EP
#define MSD_DATA_OUT_EP         MSD_DATA_EP
/* CDC */
...
#define USB_CDC_SET_LINE_CODING_HANDLER KIT_USB_Device_CDC_SetLineCodingHandler// located in kit_usb_device_cdc.h
